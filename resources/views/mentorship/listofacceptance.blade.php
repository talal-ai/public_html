    ...
    <div class="grid grid-cols-1">
        <div>
            <ul class="font-semibold text-lightgray flex items-center gap-4 sm:gap-[30px] gap-y-4 whitespace-nowrap overflow-auto">
                <li>
                    <a href="{{ route('listofacceptance') }}" class="text-dark dark:text-white duration-300">Teacher</a>
                </li>
                <li>
                    <a href="{{ route('listofacceptancebystudent') }}" class="hover:text-dark duration-300 dark:hover:text-white">Student</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="grid grid-cols-1 gap-5">
        <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-base font-semibold">List of Acceptance from Teacher</h2>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-lightgray/10">
                            ...
                            <th class="text-left py-3 px-4 bg-slate-50 dark:bg-gray-800">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="border-b border-lightgray/10 hover:bg-slate-50 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <td class="py-3 px-4">
                                <a href="{{ route('teacher.assignable.students', $userData->id) }}" class="btn btn-sm btn-primary inline-flex items-center">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                    </svg>
                                    <span class="ml-1">Assign Student</span>
                                </a>
                            </td>
                        </tr>
                        @endforeach
            ...
            <div class="text-center py-8">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">There are no mentorship agreements submitted by teachers yet.</p>
            </div>
            @endif
        </div>
    </div>
