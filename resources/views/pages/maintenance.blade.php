...
<div class="min-h-[calc(100vh-192px)] p-7 flex justify-center items-center">
    <div class="text-center">
        ...
        <img src="{{ asset('assets/images/maintenance-light.png') }}" class="lg:mt-32 sm:mt-16 mt-14 dark:hidden" alt="">
        <img src="{{ asset('assets/images/maintenance-dark.png') }}" class="lg:mt-32 sm:mt-16 mt-14 hidden dark:block" alt="">
    </div>
</div>
