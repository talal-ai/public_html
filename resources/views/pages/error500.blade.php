...
<div class="min-h-[calc(100vh-216px)] p-7 flex justify-center items-center">
    <div class="text-center">
        ...
        <img src="{{ asset('assets/images/500-light.png') }}" class="lg:mt-32 sm:mt-16 mt-14 dark:hidden" alt="">
        <img src="{{ asset('assets/images/500-dark.png') }}" class="lg:mt-32 sm:mt-16 mt-14 hidden dark:block" alt="">
    </div>
</div>
