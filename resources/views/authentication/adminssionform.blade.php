...
<div class="bg-white shadow-lg rounded-lg p-10 max-w-lg text-center">
        ...
        <p id="statusMessage" class="text-gray-600 mb-6">Thank You For Submitting Your Academic Information.</p>
   ...
   <!-- Button Container -->
    <!-- <div class="flex justify-between mt-4">
        <button id="back-to-academic-inter" class="btn-secondary w-1/2 mr-2">Back</button>
        <button id="next-to-academic-inter" class="btn-primary w-1/2 ml-2">Next</button>
    </div> -->
  </div>
    </div>
