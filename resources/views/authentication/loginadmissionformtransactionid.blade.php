    ...
    <main class="flex-1 p-12 flex items-center justify-center">
        <div class="w-full max-w-lg">
            ...
            <section class="content">
                ...
                <form class="space-y-4 " method="post" action="{{ route('processLoginadmissionwithtransactionid') }}">
                    @csrf
                    <div>
                        <label for="username" class="block text-sm font-medium text-gray-700">Transaction ID</label>
                        <input type="text" id="transactionid" name="transactionid" required class="input-field">
                        <p id="email-help" class="text-xs text-red-500 hidden">Email is required</p>
                    </div>
                    <button type="submit" class="btn-primary w-full">Login</button>
                </form>
                <h6 class="text-small font-bold mb-4">If you login with Email than <a href="{{ route('loginadmissionform') }}"
