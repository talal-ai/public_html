    ...
    <div class="relative">
        ...
        <div class="min-h-[calc(100vh-192px)] p-7 flex justify-center items-center">
            <div
                ...
                <p class="text-gray mt-5">Register to your account</p>
                <form class="mt-[60px] space-y-5" action="{{ route('registerUser') }}" method="POST">
                    @csrf
                    <div class="relative">
                ...
                <!-- <div class="flex items-center gap-2.5 mt-[30px]">
                    <div class="h-[2px] bg-gray/10 dark:bg-gray/20 flex-1"></div>
