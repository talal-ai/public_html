                ...
                <div class="flex flex-wrap items-center gap-5">
                    @foreach($user->permissionss as $role)
                        @foreach($role->permissions as $permission)
                            @if($permission->name == 'can_add' && $permission->description == 'Can Add Assignment')
                    ...
                    <div class="flex items-start justify-center min-h-screen " @click.self="open = false">
                        <div x-show="open" x-transition x-transition.duration.300
                            ...
                            <div
                                ...
                                <h5 class="font-semibold text-lg">Add Assignment</h5>
                            ...
                            <div class="p-5 space-y-4">
                                <div class="text-lightgray text-sm font-normal">
                                    <form action="{{ route('assignmentcreate') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div
                                            class="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Assignment Submission Date</h2>
                                            ...
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Total Marks</h2>
                                                <input id="totalmarks" name="totalmarks" type="text"
                                                    class="form-input w-full" placeholder="Code" required>
                                            </div>
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Topic</h2>
                                                <input id="topic" name="topic" type="text" class="form-input w-full"
                                                    placeholder="Code" required>
                                            </div>
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Assignment File</h2>
                                                <input type="file" name="assignmentpdf" id="assignmentpdf" accept=".pdf"
                                                    class="form-input w-full" required>
                                            </div>
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Program</h2>
                                                <select id="selectprogram-add" name="program" class="form-select">
                                                    <option value="" disabled selected>Select Option</option>
                                                    @foreach($programsData as $program)
                                                        <option value="{{ $program['id'] }}">
                                                            {{ $program['name'] }}
                                            ...
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Year</h2>
                                                <select id="selectyear-add" name="year" class="form-select">
                                                    <option value="" disabled selected>Select Program First</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="p-1">
                                                ...
                                                <select id="selecttype-add" name="assignmenttype" class="form-select">
                                                    <option value="" disabled selected>Select Year First</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Subject</h2>
                                                <select id="selectsubject-add" name="subject" class="form-select">
                                                    <option value="" disabled selected>Select Year First</option>
                                                </select>
                                            </div>
                                            <div class="p-1">
                                                ...
                                                <label class="inline-flex items-center">
                                                    <input type="radio" name="status" id="status"
                                                        class="form-radio text-primary" checked="" value="1">
                                                    <span class="text-sm">Active</span>
                                                </label>
                                                <label class="inline-flex items-center">
                                                    <input type="radio" name="status" id="status"
                                                        class="form-radio text-primary" checked="" value="0">
                                                    <span class="text-sm">Inactive</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Assignment Detail</h2>
                                            <textarea name="assignmentdetail" id="editor1" rows="10" cols="80">
                                                </textarea>
                                        </div>
                                </div>
                                <div
                        ...
                        <tbody>
                            <template x-for="(item, index) in items" :key="index" x-data="myComponent()">
                                <tr x-show="checkView(index + 1)" class="">
                                    ...
                                    <td>
                                        <span x-text="item.subjectname"></span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="mt-3 flex gap-8 items-center justify-center">
                                            ...
                                            @foreach($user->permissionss as $role)
                                                @foreach($role->permissions as $permission)
                                                    @if($permission->name == 'can_edit' && $permission->description == 'Can Edit Assignment')
                                                        <svg style="cursor: pointer;" @click="open = true" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                                            class="edit-assignment-icon" :data-role-id="item.id">
                                            ...
                                            @foreach($user->permissionss as $role)
                                                @foreach($role->permissions as $permission)
                                                    @if($permission->name == 'can_delete' && $permission->description == 'Can Delete Assignment')
                                                        <svg style="cursor: pointer;" width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path opacity="0.5"
...
<script type="text/javascript">
    ...
    document.getElementById('selectyear').addEventListener('change', function () {
        ...
        if (yearId) {
            ...
            document.getElementById('selectsubject').innerHTML = '<option value="" disabled selected>Frist Create Year</option>';
        }
    });
    ...
    document.getElementById('selectyear-add').addEventListener('change', function () {
        ...
        if (yearId) {
            fetch(`${baseUrl}/getsubject/${yearId}`)
                ...
                .then(data => {
                    console.log(data);
                    var selectsubject = document.getElementById('selectsubject-add');
                    selectsubject.innerHTML = '<option value="" disabled selected>Select Subject</option>';
            ...
            fetch(`${baseUrl}/getBatch/${yearId}`)
                ...
                .then(data => {
                    ...
                    // var selectbatches = document.getElementById('selectbatches-add');
                    // selectbatches.innerHTML = '<option value="" disabled selected>Select Batches</option>';

                    // data.batches.forEach(function (batche) {
                    //     var option = document.createElement('option');
                    //     option.value = batche.id;
                    //     option.textContent = batche.name;
                    //     selectbatches.appendChild(option);
                    // });
...
<script>
    function myComponent() {
        return {
            handleDownload(assignmentId) {
                var baseUrl = '{{ env("APP_URL") }}/lms';
                console.log('Assignment ID:', assignmentId);
                window.location.href = baseUrl + `/viewassignment/${assignmentId}`; // Redirect to the download URL
            }
        }
    }
</script>
