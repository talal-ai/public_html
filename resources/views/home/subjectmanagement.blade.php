        ...
        <div x-data="modals">
            @foreach($user->permissionss as $role)
                @foreach($role->permissions as $permission)
                    @if($permission->name == 'can_add' && $permission->description == 'Can Add Subject')
                ...
                <div class="flex items-start justify-center min-h-screen " @click.self="open = false">
                    <div x-show="open" x-transition x-transition.duration.300
                        ...
                        <div
                            ...
                            <h5 class="font-semibold text-lg">Add Program</h5>
                                    ...
                                    <div
                                        ...
                                        <div class="p-1">
                                            ...
                                            <input id="code" name="code" type="number"
                                                class="form-input w-full positive-only" min="0" placeholder="Class"
                                                required>
                                        </div>
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Program</h2>
                                            <select id="subjectprogram" name="subjectprogram" class="form-select">
                                        ...
                                        <div class="p-1">
                                            ...
                                            <select id="subjectyear" name="subjectyear" class="form-select">
                                                <option value="" disabled selected>Select Option</option>
                                        ...
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Type</h2>
                                            <label class="inline-flex items-center">
                                                <input type="radio" name="subjecttype" id="subjecttype"
                                                    class="form-radio text-primary" checked="" value="1">
                                                <span class="text-sm">Examinable</span>
                                            </label>
                                            <label class="inline-flex items-center">
                                                <input type="radio" name="subjecttype" id="subjecttype"
                                                    class="form-radio text-primary" checked="" value="0">
                                                <span class="text-sm">Non-Examinable</span>
                                            </label>
                                        </div>
                                        <div class="p-1">
                        ...
                        <tbody>
                            <template x-for="(item, index) in items" :key="index">
                                <tr x-show="checkView(index + 1)" class="">
                                    ...
                                    <td>
                                        <span x-text="item.subjecttype === 1 ? 'Examinable' : 'Non-Examinable'"></span>
                                    </td>
                                    <td>
...
@section('script')
<script>
    window.mergedData = @json($SubjectWithProgramyear);
    console.log(window.mergedData); // Debug to ensure data is being passed correctly
</script>
<!-- Datatables Js -->
<script src="{{ asset('public/assets/js/gernelsettingdata/datatablesubjectmanage.js') }}"></script>
