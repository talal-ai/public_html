                    ...
                    <div class="flex items-start justify-center min-h-screen " @click.self="open = false">
                        <div x-show="open" x-transition x-transition.duration.300
                            ...
                            <div
                                ...
                                <h5 class="font-semibold text-lg">Add Year</h5>
                            ...
                            <div class="p-5 space-y-4">
                                <form action="{{ route('yearcreate') }}" method="POST">
                                    @csrf
                                    <div class="text-lightgray text-sm font-normal">
                                        <div
                                            ...
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Year Name</h2>
                                                <input id="name" name="name" type="text" class="form-input w-full"
                                                    placeholder="Name" required>
                                            </div>
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Class</h2>
                                                <input id="class" name="class" type="text" class="form-input w-full"
                                                    placeholder="Class" required>
                                            </div>
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Code</h2>
                                                <input id="code" name="code" type="text" class="form-input w-full"
                                                    placeholder="Class" required>
                                            </div>
                                            <div class="p-1">
                                            ...
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Acadamic Year</h2>
                                                <select id="acadamicyear" name="acadamicyear" class="form-select">
                        ...
                        <tbody>
                            <template x-for="(item, index) in items" :key="index">
                                <tr x-show="checkView(index + 1)" class="">
                                    ...
                                    <td>
                                        <span x-text="item.acadamicyear"></span>
                                    </td>
                                    <td>
...
@section('script')
<script>
    window.yearsData = @json($yearsData);
   // console.log(window.sessionsData);
</script>
<!-- Datatables Js -->
<script src="{{ asset('public/assets/js/gernelsettingdata/datatableyear.js') }}"></script>
