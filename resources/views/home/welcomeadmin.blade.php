...
<div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
    <div class="grid grid-cols-1">
        <div>
            <ul
                class="font-semibold text-lightgray flex items-center gap-4 sm:gap-[30px] gap-y-4 whitespace-nowrap overflow-auto">
                <li>
                    <a href="" class="text-dark dark:text-white duration-300">Overview</a>
                </li>
                <li>
                    <a href="" class="hover:text-dark duration-300 dark:hover:text-white">Admission</a>
                </li>
                <li>
                    <a href="" class="hover:text-dark duration-300 dark:hover:text-white">Accounts</a>
                </li>
                <li>
                    <a href="" class="hover:text-dark duration-300 dark:hover:text-white">Payments</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
        <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
            <div class="flex items-center gap-2.5 flex-wrap">
                ...
                <div class="flex items-end gap-3">
                    <div class="flex-1">
                        <h4 class="text-lightgray text-sm">Total Student</h4>
                        <p class="font-bold text-lg mt-1.5">{{ $usertype2Count }}</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
            <div class="flex items-center gap-2.5 flex-wrap">
                ...
                <div class="flex items-end gap-3">
                    <div class="flex-1">
                        <h4 class="text-lightgray text-sm">Total Teacher</h4>
                        <p class="font-bold text-lg mt-1.5">{{ $usertype4Count }}</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
            <div class="flex items-center gap-2.5 flex-wrap">
                ...
                <div class="flex items-end gap-3">
                    <div class="flex-1">
                        <h4 class="text-lightgray text-sm">Total Faulty User</h4>
                        <p class="font-bold text-lg mt-1.5">{{ $usertype6Count }}</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
            <div class="flex items-center gap-2.5 flex-wrap">
                ...
                <div class="flex items-end gap-3">
                    <div class="flex-1">
                        <h4 class="text-lightgray text-sm">Total Admin User</h4>
                        <p class="font-bold text-lg mt-1.5">{{ $usertype5Count }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
            <div class="mb-[30px] flex items-center flex-wrap" id="totalUniqueUsersfaulty">
                <h2 class="flex-1 font-semibold">Faulty Survey</h2>
...
Total User's-><span class="bg-gray/10 text-black text-lg font-semibold py-1 px-4 rounded-full totalUniquefaulty"
                    style="cursor: pointer;">
                    {{ $faultysurveyStats['totalUniqueUsers'] }}
                </span>
            </div>
            <div id="questionlist" style="height: 260px; overflow-y: auto;">
                @foreach ($questionsWithSurveyType as $question)
                    @if ($question['survey_type'] === 'faultysurvey')
                        <div class="mb-4 p-4 border border-gray-200 rounded question-item"
                            data-question-id="{{ $question['id'] }}" data-survey-name="{{ $question['survey_type'] }}"
                            style="cursor: pointer;">
                            <p class="text-lg font-medium text-gray-700" style="cursor: pointer;">
        ...
        <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg relative">
            <h2 class="mb-[30px] font-semibold">Survey Result</h2>
            <div id="faultysurvey"></div>
            <!-- Loader -->
            <div id="loaderfaulty" class="absolute inset-0 flex justify-center items-center bg-white/80 hidden">
                <div class="relative">
                    <span class="inline-block" style="width: 7.25rem;height: 7.25rem;">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
            <div class="mb-[30px] flex items-center flex-wrap" id="totalUniqueUserscourse">
                <h2 class="flex-1 font-semibold">Course Evaluation Survey</h2>
                Excel-><a href="{{ route('exportSurveyStats_course') }}" class="inline-block">           
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right:10px;">
<path opacity="0.5" d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12" stroke="#1C274C" stroke-width="1.5"/>
<path d="M2 14C2 11.1997 2 9.79961 2.54497 8.73005C3.02433 7.78924 3.78924 7.02433 4.73005 6.54497C5.79961 6 7.19974 6 10 6H14C16.8003 6 18.2004 6 19.27 6.54497C20.2108 7.02433 20.9757 7.78924 21.455 8.73005C22 9.79961 22 11.1997 22 14C22 16.8003 22 18.2004 21.455 19.27C20.9757 20.2108 20.2108 20.9757 19.27 21.455C18.2004 22 16.8003 22 14 22H10C7.19974 22 5.79961 22 4.73005 21.455C3.78924 20.9757 3.02433 20.2108 2.54497 19.27C2 18.2004 2 16.8003 2 14Z" stroke="#1C274C" stroke-width="1.5"/>
<path d="M12 11L12 17M12 17L14.5 14.5M12 17L9.5 14.5" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
Pdf-><a href="{{ route('exportSurveyStatsCourseToPDF') }}" class="inline-block">           
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right:10px;">
<path opacity="0.5" d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12" stroke="#1C274C" stroke-width="1.5"/>
<path d="M2 14C2 11.1997 2 9.79961 2.54497 8.73005C3.02433 7.78924 3.78924 7.02433 4.73005 6.54497C5.79961 6 7.19974 6 10 6H14C16.8003 6 18.2004 6 19.27 6.54497C20.2108 7.02433 20.9757 7.78924 21.455 8.73005C22 9.79961 22 11.1997 22 14C22 16.8003 22 18.2004 21.455 19.27C20.9757 20.2108 20.2108 20.9757 19.27 21.455C18.2004 22 16.8003 22 14 22H10C7.19974 22 5.79961 22 4.73005 21.455C3.78924 20.9757 3.02433 20.2108 2.54497 19.27C2 18.2004 2 16.8003 2 14Z" stroke="#1C274C" stroke-width="1.5"/>
<path d="M12 11L12 17M12 17L14.5 14.5M12 17L9.5 14.5" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                Total User's-><span class="bg-gray/10 text-black text-lg font-semibold py-1 px-4 rounded-full totalUniquecourse"
                    style="cursor: pointer;">
                    {{ $coursesurveyStats['totalUniqueUsers'] }}
                </span>
            </div>
            <div id="questionlistcourse" style="height: 260px;overflow-y: auto;">
                @foreach ($questionsWithSurveyType as $question)
                    @if ($question['survey_type'] === 'coursesurvey')
                        <div class="mb-4 p-4 border border-gray-200 rounded course-question-item"
                            data-coursequestion-id="{{ $question['id'] }}"
                            data-coursesurvey-name="{{ $question['survey_type'] }}" style="cursor: pointer;">
                            <p class="text-lg font-medium text-gray-700" style="cursor: pointer;">
                                {{ $question['question_text'] }}
                            </p>
                        </div>
        ...
        <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg relative">
            <h2 class="mb-[30px] font-semibold">Survey Result</h2>
            <div id="coursesurvey"></div>
            <!-- Loader -->
            <div id="loader" class="absolute inset-0 flex justify-center items-center bg-white/80 hidden">
                <div class="relative">
                    <span class="inline-block" style="width: 7.25rem;height: 7.25rem;">
                        <span class="animate-ping inline-flex h-full w-full rounded-full bg-success/50"></span>
                    </span>
...
<script src="{{ asset('public/assets/js/apex-ecom.js') }}"></script>
<script src="{{ asset('public/assets/js/chart-custom.js') }}"></script>
<script src="{{ asset('public/assets/js/coursechart.js') }}"></script>

<script>
    var faultyChartInstance;
    var courseChartInstance;


    document.addEventListener('DOMContentLoaded', function () {
        // Initial survey stats (if needed for default view)
        var courseStats = @json($coursesurveyStats['stats']);
        var courseData = Object.values(courseStats); // Extract the values
        console.log(courseData);
        var surveyStats = @json($faultysurveyStats['stats']);
        var surveyData = Object.values(surveyStats); // Extract the values
        console.log(surveyData);
        // Render the initial charts and store the instances
        courseChartInstance = createCourseSurveyChart(courseData);
        faultyChartInstance = createFaultySurveyChart(surveyData);
    });

    //document.addEventListener('DOMContentLoaded', function () {
    $(document).ready(function () {
        $('#totalUniqueUserscourse').on('click', '.totalUniquecourse', function () {
    ...
    $(document).ready(function () {
        $('#totalUniqueUsersfaulty').on('click', '.totalUniquefaulty', function () {
            // Check if a chart instance already exists, and if so, destroy it
            if (faultyChartInstance) {
                faultyChartInstance.destroy();
            }
            // Initial survey stats (if needed for default view)
            var surveyStats = @json($faultysurveyStats['stats']);
            var surveyData = Object.values(surveyStats); // Extract the values
    ...
    $(document).ready(function () {
        $('#questionlist').on('click', '.question-item', function () {
            ...
            fetch(`{{ env("APP_URL") }}/get-question-stats/${questionId}/${surveyName}`)
                ...
                .then(data => {
                    document.querySelector("#loaderfaulty").classList.remove('hidden');
                    var chartData = Object.values(data.stats);
                    console.log('Fetched data:', chartData);
                    if (surveyName === 'faultysurvey') {
                        ...
                        // Use your existing chart creation function with the new data
                        faultyChartInstance = createFaultySurveyChart(chartData);
                    }
                    setTimeout(() => {
                            document.querySelector("#loaderfaulty").classList.add('hidden');
                        }, 1000); // Delay of 3 seconds
                })
                .catch(error => console.error('Error fetching question stats:', error));
        });

        $('#questionlistcourse').on('click', '.course-question-item', function () {
            console.log('Click event triggered on course survey');
            var coursequestionId = $(this).data('coursequestion-id');
            var coursesurveyName = $(this).data('coursesurvey-name');
            console.log('Clicked question ID:', coursequestionId);

            fetch(`{{ env("APP_URL") }}/get-question-stats/${coursequestionId}/${coursesurveyName}`)
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
                ...
                .then(data => {
                    var chartData = Object.values(data.stats);
                    console.log('Fetched data:', chartData);
                    if (coursesurveyName === 'coursesurvey') {
                        // Show the loader
                        ...
                        // Use your existing chart creation function with the new data
                        courseChartInstance = createCourseSurveyChart(chartData);
                        setTimeout(() => {
