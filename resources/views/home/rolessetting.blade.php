            ...
            <div x-data="modals">
                @foreach($user->permissionss as $role)
                        @foreach($role->permissions as $permission)
                                    @if($permission->name == 'can_add' && $permission->description == 'Can Add Roles')
                    ...
                    <div class="flex items-start justify-center min-h-screen " @click.self="open = false">
                        <div x-show="open" x-transition x-transition.duration.300
                            ...
                            <div
                                ...
                                <h5 class="font-semibold text-lg">Add Role</h5>
                                ...
                                <form action="{{ route('createrole') }}" method="POST">
                                    ...
                                    <div class="text-lightgray text-sm font-normal">
                                        <div
                                            ...
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Role Name</h2>
                                            ...
                                            <div class="p-1">
                                                ...
                                                <label class="inline-flex items-center">
                                                    <input type="checkbox" id="editstudentattendance"
                                                        name="editstudentattendance" value="14"
                                                        class="form-checkbox text-primary">
                                                    <span class="text-sm">Edit Student Attendance Status</span>
                                                </label>
                                            </div>
                                            <div class="p-1">
                                            </div>
                                        ...
                                        <table id="myTable" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                @foreach($permissions as $programId => $programPermissions)

                                                                                                                                                @php
                                                                                                                                                    // Get the first permission to retrieve the program name
                                                                                                                                                    $firstPermission = $programPermissions->first();
                                                                                                                                                    $programName = $firstPermission && $firstPermission->program ? $firstPermission->program->name : 'Unknown Program';
                                                                                                                                                @endphp

                                                                                                <!-- Display the Program Name -->
                                                                                                <tr class="group-row collapsed" data-group="{{ $programId }}">
                                                                                                ...
                                                                                                @foreach($programPermissions->where('parent_id', 0) as $permission)
                                                                                                                                                                                                                                        <!-- Child Rows -->
                                                                                                                                            <tr id="row_{{ $permission->id }}" role="row" class="odd hidden-row"
                                                                                                                                                data-group="{{ $programId }}">
                                                                                                                                                <td>
                                                                                                                                                    {{ $permission->description }}
                                                                                                                                                </td>

                                                                                                                                                @php
                                                                                                                                                    $canViewPermission = $programPermissions->where('parent_id', $permission->id)->where('name', 'can_view')->first();
                                                                                                                                                    $canAddPermission = $programPermissions->where('parent_id', $permission->id)->where('name', 'can_add')->first();
                                                                                                                                                    $canModifyPermission = $programPermissions->where('parent_id', $permission->id)->where('name', 'can_modify')->first();
                                                                                                                                                    $canDeletePermission = $programPermissions->where('parent_id', $permission->id)->where('name', 'can_delete')->first();
                                                                                                                                                @endphp

                                                                                                                                                @if($canViewPermission)
                                                                                                                                                    <td class="text-center">
                                                                                                                                                        <div class="checkbox">
                                                                                                                                                            <input type="checkbox" style="border-color:#000 !important;"
                                                                                                                                                                class="chk checkbox1 editor-chkView form-checkbox text-primary"
                                                                                                                                                                value="{{ $canViewPermission->id }}"
                                                                                                                                                                id="chkView_row_{{ $canViewPermission->id }}"
                                                                                                                                                                name="chkView[]">
                                                                                                                                                            <label
                                                                                                                                                                for="chkView_row_{{ $canViewPermission->id }}"></label>
                                                                                                                                                        </div>
                                                                                                                                                    </td>
                                                                                                                                                @else
                                                                                                                                                    <td></td>
                                                                                                                                                ...
                                                                                                                                                @if($canAddPermission)
                                                                                                                                                    <td class="text-center">
                                                                                                                                                        <div class="checkbox">
                                                                                                                                                            <input type="checkbox" style="border-color:#000 !important;"
                                                                                                                                                                class="chk checkbox1 editor-chkAdd form-checkbox text-primary"
                                                                                                                                                                value="{{ $canAddPermission->id }}"
                                                                                                                                                                id="chkAdd_row_{{ $canAddPermission->id }}"
                                                                                                                                                                name="chkAdd[]">
                                                                                                                                                            <label for="chkAdd_row_{{ $canAddPermission->id }}"></label>
                                                                                                                                                        </div>
                                                                                                                                                    </td>
                                                                                                                                                @else
                                                                                                                                                    <td></td>
                                                                                                                                                ...
                                                                                                                                                @if($canModifyPermission)
                                                                                                                                                    <td class="text-center">
                                                                                                                                                        <div class="checkbox">
                                                                                                                                                            <input type="checkbox" style="border-color:#000 !important;"
                                                                                                                                                                class="chk checkbox1 editor-chkModify form-checkbox text-primary"
                                                                                                                                                                value="{{ $canModifyPermission->id }}"
                                                                                                                                                                id="chkAdd_row_{{ $canModifyPermission->id }}"
                                                                                                                                                                name="chkModify[]">
                                                                                                                                                            <label
                                                                                                                                                                for="chkAdd_row_{{ $canModifyPermission->id }}"></label>
                                                                                                                                                        </div>
                                                                                                                                                    </td>
                                                                                                                                                @else
                                                                                                                                                    <td></td>
                                                                                                                                                ...
                                                                                                                                                @if($canDeletePermission)
                                                                                                                                                    <td class="text-center">
                                                                                                                                                        <div class="checkbox">
                                                                                                                                                            <input type="checkbox" style="border-color:#000 !important;"
                                                                                                                                                                class="chk checkbox1 editor-chkDelete form-checkbox text-primary"
                                                                                                                                                                value="{{ $canDeletePermission->id }}"
                                                                                                                                                                id="chkDelete_row_{{ $canDeletePermission->id }}"
                                                                                                                                                                name="chkDelete[]">
                                                                                                                                                            <label
                                                                                                                                                                for="chkDelete_row_{{ $canDeletePermission->id }}"></label>
                                                                                                                                                        </div>
                                                                                                                                                    </td>
                                                                                                                                                @else
                                                                                                                                                    <td></td>
                                        ...
                                        <script>
                                            $(document).ready(function () {
                                                // Handle group rowsss click
                                                $('tr.group-row').on('click', function () {
                                                    var group = $(this).data('group');
                                                    console.log(group);
                                                    $(this).toggleClass('collapsed');
                                                    $('tr[data-group="' + group + '"]').not('.group-row').toggleClass('hidden-row');
                                    ...
                                    <td>
                                        <div class="mt-3 flex gap-8 items-center justify-center">
                                            ...
                                            <svg style="cursor: pointer;" @click="open = true" width="24" height="24"
                                                ...
                                                class="edit-roleid-icon" :data-role-id="item.id">
...
<div id="roleEditModal"
    ...
    <div class="flex items-start justify-center min-h-screen" id="modalContent">
        <div class="bg-white dark:bg-dark dark:border-gray/20 border-lightgray/10 overflow-hidden w-full max-w-5xl">
            <div
                class="flex bg-white dark:bg-dark items-center border-b border-lightgray/10 dark:border-gray/20 justify-between px-5 py-3">
                <h5 class="font-semibold text-lg">Edit Roles</h5>
            ...
            <form action="{{ route('updaterole') }}" method="POST">
                                    ...
                                    <div class="text-lightgray text-sm font-normal">
                                        <div
                                            ...
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4">Role Name</h2>
                                                <input id="rolenameid-edit" name="rolenameid-edit" type="hidden"
                                                    class="form-input w-full" >
                                                <input id="rolename-edit" name="rolename-edit" type="text"
                                                    class="form-input w-full" placeholder="Full Name" required>
                                            </div>
                                            <div class="p-1">
                                                <h2 class="text-base font-semibold mb-4"></h2>
                                                <label class="inline-flex items-center">
                                                    <input type="checkbox" id="editstudentattendance-edit"
                                                        name="editstudentattendance-edit" value="14"
                                                        class="form-checkbox text-primary">
                                                    <span class="text-sm">Edit Student Attendance Status</span>
                                                </label>
                                            </div>
                                        ...
                                        <table id="myTableedit" class="display" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th style="text-align: left;">Module Name</th>
                                                    <th>View</th>
                                            ...
                                            <tbody>
        <!-- The generated rows will be appended here -->
    </tbody>
                                        </table>
                                    </div>
                                    <div
...
<!-- Datatables Js -->
<script src="{{ asset('public/assets/js/gernelsettingdata/datatableroles.js') }}"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function populateModal(data, roleId) {
    // Set role name and ID
    $('#rolename-edit').val(data.name);
    $('#rolenameid-edit').val(data.id);

    // Generate the table rows for permissions
    let tableBodyHtml = '';
    for (let programId in data.permissions) {
        if (data.permissions.hasOwnProperty(programId)) {
            const programPermissions = data.permissions[programId];
            if (programPermissions.length > 0) {
                // Get the program name from the first permission
                const programName = programPermissions[0].program ? programPermissions[0].program.name : 'Unknown Program';

                // Add a row for the program name
                tableBodyHtml += `
                    <tr class="group-row-edit collapsed" data-group="${programId}">
                        <td colspan="9" style="text-align:left;">
                            <i class="fa fa-chevron-right"></i> <strong>${programName}</strong>
                        </td>
                    </tr>`;

                // Loop through the parent permissions and generate child rows
                programPermissions.forEach(permission => {
                    if (permission.parent_id === 0) {
                        const canViewPermission = programPermissions.find(p => p.parent_id === permission.id && p.name === 'can_view');
                        const canAddPermission = programPermissions.find(p => p.parent_id === permission.id && p.name === 'can_add');
                        const canModifyPermission = programPermissions.find(p => p.parent_id === permission.id && p.name === 'can_modify');
                        const canDeletePermission = programPermissions.find(p => p.parent_id === permission.id && p.name === 'can_delete');

                        tableBodyHtml += `
                            <tr id="row_${permission.id}" role="row" class="odd hidden-row" data-group="${programId}">
                                <td>${permission.description}</td>`
                                if (canViewPermission) {
                                    tableBodyHtml += `<td class="text-center">
                                    <div class="checkbox">
                                        <input type="checkbox" style="border-color:#000 !important;" class="chk checkbox1 editor-chkView form-checkbox text-primary" value="${canViewPermission ? canViewPermission.id : ''}"
                                               id="chkView_row_${canViewPermission ? canViewPermission.id : ''}" name="chkView[]"
                                               ${data.role_permissions.includes(canViewPermission ? canViewPermission.id : '') ? 'checked' : ''}>
                                        <label for="chkView_row_${canViewPermission ? canViewPermission.id : ''}"></label>
                                    </div>
                                </td>`
                                }else{
                                    tableBodyHtml +=  `<td></td>`
                                ...
                                if (canAddPermission) {
                                    tableBodyHtml +=  ` <td class="text-center">
                                    <div class="checkbox">
                                        <input type="checkbox" style="border-color:#000 !important;" class="chk checkbox1 editor-chkAdd form-checkbox text-primary" value="${canAddPermission ? canAddPermission.id : ''}"
                                               id="chkAdd_row_${canAddPermission ? canAddPermission.id : ''}" name="chkAdd[]"
                                               ${data.role_permissions.includes(canAddPermission ? canAddPermission.id : '') ? 'checked' : ''}>
                                        <label for="chkAdd_row_${canAddPermission ? canAddPermission.id : ''}"></label>
                                    </div>
                                </td>`
                                }else{
                                    tableBodyHtml +=  `<td></td>`
                                ...
                                if (canModifyPermission) {
                                    tableBodyHtml += `<td class="text-center">
                                    <div class="checkbox">
                                        <input type="checkbox" style="border-color:#000 !important;" class="chk checkbox1 editor-chkModify form-checkbox text-primary" value="${canModifyPermission ? canModifyPermission.id : ''}"
                                               id="chkModify_row_${canModifyPermission ? canModifyPermission.id : ''}" name="chkModify[]"
                                               ${data.role_permissions.includes(canModifyPermission ? canModifyPermission.id : '') ? 'checked' : ''}>
                                        <label for="chkModify_row_${canModifyPermission ? canModifyPermission.id : ''}"></label>
                                    </div>
                                </td>`
                                }else{
                                    tableBodyHtml +=  `<td></td>`
                                ...
                                tableBodyHtml +=  `<td class="text-center">
                                    <div class="checkbox">
                                        <input type="checkbox" style="border-color:#000 !important;" class="chk checkbox1 editor-chkDelete form-checkbox text-primary" value="${canDeletePermission ? canDeletePermission.id : ''}"
                                               id="chkDelete_row_${canDeletePermission ? canDeletePermission.id : ''}" name="chkDelete[]"
                                               ${data.role_permissions.includes(canDeletePermission ? canDeletePermission.id : '') ? 'checked' : ''}>
                                        <label for="chkDelete_row_${canDeletePermission ? canDeletePermission.id : ''}"></label>
                                    </div>
                                </td>`
                                }else{
                                    tableBodyHtml +=  `<td></td>`
    ...
    $('#myTableedit tbody').html(tableBodyHtml);

    // Re-initialize any event handlers for the new content (e.g., expanding rows)
    $('tr.group-row-edit').on('click', function () {
        var group = $(this).data('group');
        $(this).toggleClass('collapsed');
        $('tr[data-group="' + group + '"]').not('.group-row-edit').toggleClass('hidden-row');
        $(this).find('.fa').toggleClass('fa-chevron-right fa-chevron-down');
    });
}
        ...
        $('.edit-roleid-icon').on('click', function () {
            ...
            fetch(`${baseUrl}/get-role-data/${roleId}`)
                .then(response => response.json())
                .then(data => {
                    console.log(data);
                    populateModal(data, roleId);
                    setTimeout(function () {
                        $('#roleEditModal').removeClass('hidden');
