        ...
        <div x-data="modals">
            @foreach($user->permissionss as $role)
                @foreach($role->permissions as $permission)
                    @if($permission->name == 'can_add' && $permission->description == 'Can Add Category')
                ...
                <div class="flex items-start justify-center min-h-screen " @click.self="open = false">
                    <div x-show="open" x-transition x-transition.duration.300
                        ...
                        <div
                            ...
                            <h5 class="font-semibold text-lg">Add New Categorys</h5>
                            ...
                            <form action="{{ route('categorycreate') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="text-lightgray text-sm font-normal">
                                    <div
                                        ...
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Category Name</h2>
                                            <input id="catname" name="catname" type="text" class="form-input w-full"
                                                placeholder="Category Name" required>
                                        </div>
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Description</h2>
                                            <input id="catdes" name="catdes" type="text" class="form-input w-full"
...
@section('script')
<script>
    window.mergedData = @json($categorysData);
