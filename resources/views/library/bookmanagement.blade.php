        ...
        <div>
            <ul class="flex flex-wrap items-center text-sm font-semibold space-x-2.5">
                <li class="flex items-center space-x-2.5 text-gray hover:text-dark dark:hover:text-white duration-300">
                    <a href="javaScript:;">Library Section</a>
        ...
        <div x-data="modals">
            @foreach($user->permissionss as $role)
                @foreach($role->permissions as $permission)
                    @if($permission->name == 'can_add' && $permission->description == 'Can Add Book')
                ...
                <div class="flex items-start justify-center min-h-screen " @click.self="open = false">
                    <div x-show="open" x-transition x-transition.duration.300
                        ...
                        <div
                            ...
                            <h5 class="font-semibold text-lg">Add New Book</h5>
                            ...
                            <form action="{{ route('bookscreate') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="text-lightgray text-sm font-normal">
                                    <div
                                        ...
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Book Name</h2>
                                            <input id="bookname" name="bookname" type="text" class="form-input w-full"
                                                placeholder="Book Name" required>
                                        </div>
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Book Author</h2>
                                            <input id="bookauthor" name="bookauthor" type="text"
                                                class="form-input w-full" placeholder="Book Author" required>
                                        </div>
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Description of Book</h2>
                                            <input id="bookdes" name="bookdes" type="text" class="form-input w-full"
                                                placeholder="Description of Book" required>
                                        </div>
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Total Available Books</h2>
                                            <input id="maxallowed" name="maxallowed" type="number"
                                                class="form-input w-full" placeholder="Total Available Books" required>
                                        </div>
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Book Cover</h2>
                                            <input id="bookcover" name="bookcover" type="file" class="form-input w-full"
                                                required>
                                        </div>
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Book (PDF)</h2>
                                            <input type="file" name="pdf" id="pdf" accept=".pdf"
                                                class="form-input w-full" required>
                                        </div>
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Category</h2>
                                            <select id="bookcat" name="bookcat" class="form-select">
                                                <option value="" disabled selected>Select Option</option>
                                                @foreach($categorysData as $categorys)
                                        ...
                                        <div class="p-1">
                                            <h2 class="text-base font-semibold mb-4">Programs</h2>
                        ...
                        <tbody>
                            <template x-for="(item, index) in items" :key="index">
                                <tr x-show="checkView(index + 1)" class="">
                                    <td>
                                        <span x-text="item.bookname"></span>
                                    </td>
                                    <td>
                                        <span x-text="item.bookauthor"></span>
                                    </td>
                                    <td>
                                        <span x-text="item.bookdes"></span>
                                    </td>
                                    <td>
...
@section('script')
<script>
    window.mergedData = @json($booksData);
    console.log(window.mergedData); // Debug to ensure data is being passed correctly
</script>
<!-- Datatables Js -->
<script src="{{ asset('public/assets/js/gernelsettingdata/datatablebookmanagement.js') }}"></script>
